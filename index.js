...
const birthday_image = document.getElementById('birthday_image');
...
const start = async () => {
  ...
  await visual.init('https://cdn.discordapp.com/attachments/1094231129004986379/1145942573035307039/music__love__guitar__sarigamapaJPG.jpg');
